...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2021 at 03:21 AM
...
--
-- Table structure for table `bukti_peminjaman`
--
...
--
-- Indexes for table `bukti_peminjaman`
--
ALTER TABLE `bukti_peminjaman`
...
--
-- AUTO_INCREMENT for table `bukti_peminjaman`
--
ALTER TABLE `bukti_peminjaman`
...
--
-- Constraints for table `bukti_peminjaman`
--
ALTER TABLE `bukti_peminjaman`
  ADD CONSTRAINT `bukti_peminjaman_ibfk_1` FOREIGN KEY (`id_peminjaman`) REFERENCES `peminjaman` (`id_peminjaman`) ON DELETE NO ACTION ON UPDATE CASCADE;
